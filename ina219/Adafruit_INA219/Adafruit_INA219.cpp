...
/*!
 *  @brief  Configures to INA219 to be able to measure up to 32V and 50A
 *          of current.  Each unit of current corresponds to 2 mA, and
 *          each unit of power corresponds to 40mW. Counter overflow
 *          occurs at 53.3A.
 *  @note   These calculations assume a 0.0015 ohm resistor is present
 */
void Adafruit_INA219::setCalibration_32V_50A() {

  ina219_calValue = 13653;
  ina219_currentDivider_mA = 0.5;
  ina219_powerMultiplier_mW = 40;
