...
<html>
  ...
  <body>
    ...
    <table width="40%" align="center">
      <tr>
        <td width="40%">counter</td>
        <td width="10%">:</td> 
        <td width="20%" align="right"><span id='counter'></span></td>
        <td width="30%"></td>
      </tr> 
      <tr>
        <td width="40%">rawDist</td>
        <td width="10%">:</td> 
        <td width="20%" align="right"><span id='rawDist'></span></td>
        <td width="30%">cm</td>
      </tr> 
      <tr>
      ...
      <tr>
        <td width="40%">Water Level %</td>
        <td width="10%">:</td> 
        <td width="20%" align="right"><span id='percentage'></td>
        <td width="30%">%</td>
      </tr>       
      <tr>
        <td width="40%">Water Level</td>
        <td width="10%">:</td> 
        <td width="20%" align="right"><span id='waterLevel'></td>
        <td width="30%">cm</td>
      </tr>
      <tr>
        <td width="40%">Tank Volume</td>
        <td width="10%">:</td> 
        <td width="20%" align="right"><span id='volume'></span></td>
        <td width="30%">L</td>
      </tr>
      <tr>
        <td>RelayState1</td>
