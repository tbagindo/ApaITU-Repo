...
String page ="<html><body><h1>NodeMCU WiFi & WebServer</h1><p>Duration : <span id='duration'>@@DURATION@@</span> us</p><p>Distance : <span id='distance'>@@DISTANCE@@</span> cm</P></body><script>setInterval(function ( ) {var xhttp = new XMLHttpRequest();xhttp.onreadystatechange = function() {if (this.readyState == 4 && this.status == 200) {document.getElementById('duration').innerHTML = this.responseText;}};xhttp.open('GET', '/getDuration', true);xhttp.send();}, 500 ) ;setInterval(function ( ) {var xhttp = new XMLHttpRequest();xhttp.onreadystatechange = function() {if (this.readyState == 4 && this.status == 200) {document.getElementById('distance').innerHTML = this.responseText;}};xhttp.open('GET', '/getDistance', true);xhttp.send();}, 500 ) ;</script></html>";
